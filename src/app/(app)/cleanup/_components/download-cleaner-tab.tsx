  ...
  return (
    <div className={`grouped-row flex-col items-stretch gap-3 ${error ? 'bg-destructive/5' : ''}`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
        <FieldRow label="Categories" hint="qBittorrent categories. Empty = applies to all categories.">
          <TokenInput
        ...
        <FieldRow label="Tracker patterns" hint="Domain suffixes (e.g. example.org). Empty = any tracker.">
          <TokenInput
        ...
        <FieldRow label="Tags — match any" hint="Rule matches if torrent has at least one of these qBit tags.">
          <TokenInput
            value={rule.tagsAny}
        ...
        <FieldRow label="Tags — match all" hint="Rule matches only if torrent has all these qBit tags.">
          <TokenInput
            value={rule.tagsAll}
        ...
        <FieldRow label="Privacy scope" hint="Limit to public, private, or both kinds of torrents.">
        ...
        <FieldRow label="Max ratio" hint="-1 disables the ratio check. Use with Min seed time below.">
          <Input
            type="number"
            step={0.1}
            value={rule.maxRatio}
        ...
        <FieldRow label="Min seed time (hours)" hint="Used together with Max ratio (both must be met for ratio-based removal).">
          <Input
            type="number"
            min={0}
            step={0.5}
        ...
        <FieldRow label="Max seed time (hours)" hint="-1 disables. When met, removes regardless of ratio.">
          <Input
            type="number"
            step={0.5}
        ...
        <FieldRow label="Delete source files" hint="Also delete the files on disk. Off only removes from qBittorrent.">
