...
export const SETTINGS_SHORTCUTS: SettingsShortcut[] = [
  ...
  { key: 'file-audit', label: 'Operation audit', subtitle: 'File changes and destructive media actions', href: '/settings/file-audit', iconName: 'FileStack', icon: FileStack, iconBg: 'bg-amber-500/10', iconColor: 'text-amber-400', adminOnly: true },
