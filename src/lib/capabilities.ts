...
export const CAPABILITY_GROUPS = [
  {
    ...
    items: [
      ...
      { cap: 'movies.manageFiles', label: 'Manage movie files (edit / import)' },
      ...
      { cap: 'series.manageFiles', label: 'Manage episode files (edit / import)' },
      ...
      { cap: 'music.view', label: 'View music' },
      { cap: 'music.add', label: 'Add artists/albums to library' },
      { cap: 'music.delete', label: 'Delete artists/albums' },
      { cap: 'music.editMonitoring', label: 'Change music monitoring' },
      { cap: 'music.editTags', label: 'Edit artist tags' },
      { cap: 'music.changePath', label: 'Change artist root folder/path' },
  ...
  },
  {
    ...
    items: [
      ...
      { cap: 'jellyfin.watchedState', label: 'Mark watched / unwatched in Jellyfin' },
  ...
  },
  {
    ...
    items: [
      ...
      { cap: 'notify.scheduled', label: 'Receive scheduled alert notifications' },
...
export const EVENT_TYPE_TO_CAPABILITY: Record<NotificationEventType, Capability> = {
  ...
  scheduledAlert: 'notify.scheduled',
